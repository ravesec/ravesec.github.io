...
Now that we have everything we need, we can add the [Proxmox via Prometheus](https://grafana.com/grafana/dashboards/10347-proxmox-via-prometheus/) to Grafana.
